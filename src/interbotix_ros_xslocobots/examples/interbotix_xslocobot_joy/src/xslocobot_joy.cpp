...
static const double MAX_BASE_X = 0.7/8;         // Max translational motion that the base can do is 0.7 m/s
static const double MAX_BASE_THETA = 3.14/8;    // Max rotational motion that the base can do is 3.14 rad/s
