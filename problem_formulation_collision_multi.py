file:///home/rosario/base_pose_opt_multi_dynamic_SIM/src/base_optimization/src/base_optimization/problem_formulation_collision_multi.py {"mtime":1767113454790,"ctime":1766941023379,"size":6473,"etag":"3fcnn6p5q6mp","orphaned":false,"typeId":""}
#!/usr/bin/env python3
import numpy as np
from pymoo.core.problem import ElementwiseProblem
from scipy.spatial.transform import Rotation

# mi servono questi argomenti:
# risoluzione dell'immagine
# origine della grid map

# ATTENZIONE: io qui calcolo la posizione del centro dell'ellissoide
# ma devo controllare che la posizione della base del robot sia valida
# secondo ma grid map.
# Quindi mi serve anche la trasformata che mi permette di calcolare la
# posizione della base del robot a partire dalla posizione del centro
# dell'ellissoide
